...
class TUserProfileTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text('John Jaycrown', style: Theme.of(context).textTheme.headlineSmall!.apply(color: TColors.white)),
      subtitle: Text('jaycrown9119@gmail.com', style: Theme.of(context).textTheme.bodyMedium!.apply(color: TColors.white)),
